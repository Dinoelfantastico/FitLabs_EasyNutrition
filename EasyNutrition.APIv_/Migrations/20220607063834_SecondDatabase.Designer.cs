...
namespace EasyNutrition.APIv_.Migrations
{
    ...
    [Migration("20220607063834_SecondDatabase")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("EasyNutrition.APIv_.CoreBussines.Domain.Models.SessionDetail", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                    ...
                    b.HasKey("Id")
                        .HasName("p_k_session_detail");

                    b.HasIndex("SessionId")
                        .HasDatabaseName("i_x_session_detail_session_id");

                    b.HasIndex("UserId")
                        .HasDatabaseName("i_x_session_detail_user_id");
            ...
            modelBuilder.Entity("EasyNutrition.APIv_.CoreBussines.Domain.Models.SessionDetail", b =>
                {
                    b.HasOne("EasyNutrition.APIv_.CoreBussines.Domain.Models.Session", "Session")
                        ...
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("f_k_session_detail_session_session_id");
                    ...
                    b.HasOne("EasyNutrition.APIv_.CoreBussines.Domain.Models.User", "User")
                        ...
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("f_k_session_detail__users_user_id");
